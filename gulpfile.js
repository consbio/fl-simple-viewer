...
gulp.task("compress-js", function() {
    return gulp
        .src(["static/src/config.js", "static/src/utils.js", "static/src/main.js", "static/src/reporter.js"])
        .pipe(concat("core.js"))
...
gulp.task("compress-pdf-css", ["less"], function() {
    return gulp
        .src(["node_modules/leaflet/dist/leaflet.css", "build/common.css", "build/pdf.css"])
        .pipe(cleanCSS())
...
gulp.task("copy-files", [], function() {
    return gulp.src(["node_modules/leaflet/dist/images/*"]).pipe(gulp.dest("static/dist/images"));
});
